...
class StringHandle:
    ...
    def strDateFormat(date = datetime.utcnow()):
        ...
        day     = StringHandle.strTwoDigitNumber(time.tm_mday)
        month   = strMonth[time.tm_mon]
        year    = time.tm_year
        hour    = StringHandle.strTwoDigitNumber(time.tm_hour)
        minute  = StringHandle.strTwoDigitNumber(time.tm_min)
        second  = StringHandle.strTwoDigitNumber(time.tm_sec)
